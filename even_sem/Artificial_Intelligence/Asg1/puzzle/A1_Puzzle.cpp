 ...
 *  the knight can reach a particular target cell or not) along with some
 *  obstacles 0 -> obstacle, the start cell cannot be obstacle
 *
 */
...
void getPathUsingDFS(int start_x, int start_y, int target_x, int target_y, vector<pair<int,int>> &path,
                     vector<pair<int, int>> &temp_path, vector<vector<bool>> &vis) {
...
// performing dls to check whether the goal can be reached within the given
// limits or not
void getPathUsingDLS(int start_x, int start_y, int target_x, int target_y, vector<pair<int, int>> &path,
                     vector<pair<int, int>> &temp_path, vector<vector<bool>> &vis, int limit, int max_limit) {
