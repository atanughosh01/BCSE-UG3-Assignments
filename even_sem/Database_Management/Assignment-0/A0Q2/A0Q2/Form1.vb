Public Class Form1
    ...
    Public dcode = New String() {"CSE", "ETCE", "EE", "MECH", "CIVIL", "IT"}
    Public dname = New String() {"Computer Science", "Electronics", "Electrical", "Mechanical", "Civil", "Information"}
    Dim s As Student
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        students.Add(New Student(1, dname(0), dcode(0), "Atanu", "Burdwan", "001910501005"))
        students.Add(New Student(2, dname(1), dcode(1), "Saurabh", "Jharkhand", "001510501006"))
        students.Add(New Student(3, dname(2), dcode(2), "Sayan", "Durgapur", "001810501001"))
        students.Add(New Student(4, dname(2), dcode(2), "Sneha", "Jadavpur", "001810501004"))
        students.Add(New Student(5, dname(5), dcode(5), "Sagniik", "Chinsurah", "001310501002"))
        students.Add(New Student(6, dname(3), dcode(3), "Anindya", "Durgapur", "001410401007"))
        students.Add(New Student(7, dname(1), dcode(1), "Karan", "Kolkata", "001510501009"))
        students.Add(New Student(8, dname(4), dcode(4), "Srirupa", "Kolkata", "001710501014"))
        students.Add(New Student(9, dname(3), dcode(3), "Koustav", "Asansol", "001410501023"))
        students.Add(New Student(10, dname(0), dcode(0), "Debarghya", "Asansol", "001910501070"))
        students.Add(New Student(11, dname(5), dcode(5), "Abhishek", "Bandel", "001110501001"))
        displayStart = 0
        DisplayButtons()
